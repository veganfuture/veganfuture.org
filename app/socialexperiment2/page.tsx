export default function SocialExperiment2() {
  return <>
    ...
    <p>
      The full script can be read <a className="underline" href="https://docs.google.com/document/d/11beg4mV3onyzW9iyT2RLC7Egp9sOmYI94LE3nPQLoSA/edit?usp=sharing">here</a>. Feel free to use it!
    </p>
  </>;
}
